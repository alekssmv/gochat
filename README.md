<h1>Описание</h1>
Backend код писал с нуля без использования шаблона, используя сторонние go модули. Для создания Cli команд выбрал cobra-cli библиотеку. Fontend - react + vite
